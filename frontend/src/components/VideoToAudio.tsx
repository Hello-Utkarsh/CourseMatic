...
export default function VideoToAudioConverter() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#000] p-4">
      <Card className="w-full max-w-md bg-[#1F2937] text-[#FACC15]">
        <CardHeader>
        ...
        <CardContent className="">
          <div className="space-y-4">
            <div className="flex items-center justify-center w-full bg-[#1F2937]">
              <label
                htmlFor="dropzone-file"
                className="flex flex-col items-center justify-center w-full bg-[#1F2937] h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer hover:bg-[#273344]"
              >
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                  <Upload className="w-10 h-10 mb-3 text-gray-400" />
                  <p className="mb-2 text-sm text-[#FACC15]">
